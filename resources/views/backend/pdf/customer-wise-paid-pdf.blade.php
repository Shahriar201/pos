                ...
                <table>
                    <tbody>
                        <tr>
                            <td width="45%"></td>
                            <td>
                                <u><strong><span style="font-size: 15px;">Customer Wise Paid Report</span></strong></u>
                            </td>
                            <td width="30%"></td>
                        </tr>
                    </tbody>
                ...
                <table border="1" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"><strong>{{ $total_paid }} TK</strong></td>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 20%; text-align:center;">
                                <p style="text-aign:center;"><u>Seller Signature</u></p>
                            </td>
                        </tr>
                    </tbody>
                </table>

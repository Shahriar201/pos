            ...
            <div class="row">
                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>
                                ...
                                <a class="btn btn-success float-right btn-sm" href="{{ route('units.view') }}">
                                    <i class="fa fa-list"></i>Unit List</a>
                            </h3>
                        </div>
                        ...
                        {{-- User add form --}}
                        <form method="post" action="{{ (@$editData)? route('units.update', $editData->id): route('units.store') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
